<div>
    ...
    <div class="bg-gray-200 py-4 mb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            <button class="bg-white shadow h-12 px-4 rounded text-gray-700 mr-4 focus:outline-none" wire:click= "resetFilters">
                <i class="fas fa-photo-video text-xs mr-2"></i>
                Todos los cursos
            </button>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">            
