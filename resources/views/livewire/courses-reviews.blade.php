<section class="mt-4">
    <h1 class="font-bold text-3xl mb-2">Calificaciones del curso</h1>

    @can('enrolled', $course)
        <article class="mb-4">

            @can('valued', $course)
                <textarea wire:model="comment" class="form-input w-full" placeholder="Deja aquí tus comentarios sobre el curso"
                    rows="3"></textarea>
                <div class="flex">
                ...
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>Usted ya ah calificado este curso.</p>
                  </div>
            @endcan
    ...
    <div class="card">
        <div class="card-body">
            <p class="text-gray-800 text-xl mb-2"><b> Este curso tiene {{ $course->reviews->count() }} valoraciones:</b>
            </p>
