    ...
    <x-table-responsive>
        <div class="px-6 py-4 flex">
            <input wire:keydown="limpiar_page" wire:model="search" class="form-input flex-1 shadow-sm"
                placeholder="Buscar curso por nombre" type="text">
            <a class="btn btn-danger ml-2" href="{{ route('instructor.courses.create') }}"><i
                    class="fas fa-plus mr-2"></i>Nuevo Curso</a>
        </div>
        ...
        @else
            <div class="px-6 py-4">
                <strong>No hay cursos para mostrar</strong>
            </div>
