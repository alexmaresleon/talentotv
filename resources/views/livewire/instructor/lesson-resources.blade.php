<div class="card" x-data="{open: false}">
    <div class="card-body bg-yellow-100">
        ...
        <header>
            <h1 x-on:click="open= !open" class="cursor-pointer">Recursos para esta lección:</h1>
        </header>
        ...
        <div x-show = "open">
            ...
            @if ($lesson->resource)
                <div>
                    Esta leección cuenta con {{ $lesson->resource->count() }} recurso(s)
                </div>

                <div class="flex justify-between items-center">
                    <p><i wire:click="download" class="fas fa-download text-gray-500 mr-2 cursor-pointer"></i>
                        {{$lesson->resource->url}} 
                    </p>
