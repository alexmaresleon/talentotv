                    ...
                    @auth                      
                        ...
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('thecourses.courses.index') }}">
                                    {{-- {{ __('my courses') }} --}}
                                    Mis Cursos
                                </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('thecourses.courses.index') }}" :active="request()->routeIs('thecourses.courses.index')">
                    Mis Cursos
                </x-jet-responsive-nav-link>
